...
public class RenameAnimationMenu implements ConversationAbandonedListener, CommonPrompts {

    private Main main;
    public RenameAnimationMenu(Main main) {
        this.main = main;
    }
        ...
        protected Prompt acceptValidatedInput(ConversationContext param1ConversationContext, String param1String) {
            ...
            switch (param1String) {
                ...
                case "2":
                    ...
                    main.getOptionsAnimationGUI().open(player, animationSettings);
