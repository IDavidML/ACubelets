...
public class EditCommandObjectRewardConversation implements ConversationAbandonedListener, CommonPrompts {

    private Main main;
    public EditCommandObjectRewardConversation(Main main) {
        this.main = main;
    }
