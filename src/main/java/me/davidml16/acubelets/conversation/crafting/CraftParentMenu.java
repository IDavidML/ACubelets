...
public class CraftParentMenu implements ConversationAbandonedListener, CommonPrompts {

    private Main main;
    public CraftParentMenu(Main main) {
        this.main = main;
    }
            ...
            switch (param1String) {
                ...
                case "3":
                    if(param1ConversationContext.getSessionData("cubeletType") != null
                        ...
                        main.getEditCraftingCraftsGUI().reloadGUI();
                        main.getEditCraftingCraftsGUI().open((Player) param1ConversationContext.getSessionData("player"));
