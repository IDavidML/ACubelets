...
public class CraftIngredientMoneyConversation implements ConversationAbandonedListener, CommonPrompts {

    private Main main;
    public CraftIngredientMoneyConversation(Main main) {
        this.main = main;
    }
    ...
    public class RewardMenuOptions extends FixedSetPrompt {
        ...
        public String getPromptText(ConversationContext param1ConversationContext) {
            String cadena = "";
            cadena += ChatColor.GOLD + "" + ChatColor.BOLD + "\n  CUBELET INGREDIENT (MONEY) CREATION MENU\n";
