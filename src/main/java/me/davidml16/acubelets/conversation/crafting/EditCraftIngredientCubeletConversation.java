...
public class EditCraftIngredientCubeletConversation implements ConversationAbandonedListener, CommonPrompts {

    private Main main;
    public EditCraftIngredientCubeletConversation(Main main) {
        this.main = main;
    }
